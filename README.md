...
- **production-first**：默认考虑 timeout、breaker、limiter/shedder、distributed lock、service group、metrics/tracing、health/readiness 和外部依赖边界。
